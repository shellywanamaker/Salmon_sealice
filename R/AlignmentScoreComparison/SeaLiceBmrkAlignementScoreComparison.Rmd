---
title: "Sea Lice Bismark alignment score comparison"
author: "Shelly Trigg"
date: "8/13/2019"
output: 
  html_document:
...
```{r}
data <- read.csv("/Volumes/web/metacarcinus/Salmo_Calig/analyses/20190809_100K_Calig_trimG/bismarkASthreshold_bigger_comparison.txt", sep = "\t", header = TRUE, stringsAsFactors = FALSE)

#make sample column
data$Sample <- c(rep(1,10),rep(2,10))
