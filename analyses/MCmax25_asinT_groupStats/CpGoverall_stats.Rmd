...
jpeg("5x0.75grpPercMeth_boxplot.jpg", width = 6, height = 4, units = "in", res = 300)
ggplot(CpGs, aes(group,perc_meth))+geom_boxplot(fill = grpcol) + theme_bw() + theme(axis.text.x = element_text(size = 10, hjust= 1,angle = 60)) + ylab("CpG % methylation")
dev.off()
```
