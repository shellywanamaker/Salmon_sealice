...
``` r
jpeg("DMR_MCmax25DMR_Taov0.05InfestPercMeth.jpg", width = 17, height = 7, units = "in", res = 300)
...
``` r
jpeg("DMR_MCmax25DMR_Taov0.1InfestPercMeth.jpg", width = 17, height = 7, units = "in", res = 300)
...
```
    ...
    ## Warning in heatmap.2(aov_0.1_DMR_m, margins = c(5, 20), cexRow = 1.2,
